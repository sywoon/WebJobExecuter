...
local FileParser = class("FileParser")



function FileParser:ctor()
end

function FileParser:deal(from, to)
...
function FileParser:_dealTwoFolder(from, to, storage)
...
function FileParser:_findDiffFolderAndFiles(from, to)
...
function FileParser:_cutRootPath(pathes, rootPath)
    local data = {}
...
function FileParser:_addRootPath(pathes, rootPath)
    local data = {}
    for _, path in ipairs(pathes) do
